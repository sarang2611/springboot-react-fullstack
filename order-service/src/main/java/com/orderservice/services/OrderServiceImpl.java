...
import com.orderservice.enums.EOrderPaymentStatus;
import com.orderservice.enums.EOrderStatus;
import com.orderservice.exceptions.ResourceNotFoundException;
import com.orderservice.exceptions.ServiceLogicException;
import com.orderservice.feigns.CartService;
import com.orderservice.feigns.NotificationService;
import com.orderservice.feigns.UserService;
...
public class OrderServiceImpl implements OrderService {
    ...
    private boolean sendConfirmationEmail(UserDto user, Order order) {
        ...
        MailRequestDto mail = MailRequestDto.builder()
                .to(user.getEmail())
                .subject("E-ShopZ - Order confirmation")
                .body(content)
                .build();
